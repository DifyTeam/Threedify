...
> Threedify — Criando ferramentas 3D, linha por linha, do zero.
...
- 🧠 Deixar mais **técnico** (nível paper / engine)
- 🎮 Ajustar para foco em **game engine**
- 📱 Ajustar para foco **Android-first**
